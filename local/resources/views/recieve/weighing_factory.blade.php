...
@section('main')
                ...
                <div class="card">
                  <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <div class="row">
                                <div class="col-lg-4"><h2 style="color:red;margin-bottom: 0px;height: 0px;">รายงานการชั่งน้ำหนัก (โรงงาน) &nbsp;&nbsp;
                                    <a class="btn btn-success" data-toggle="modal" data-target="#addweight" >
                                ...
                                <table class="table table-striped table-bordered nowrap" width="100%" id="recieveTable">
                                  <thead class="text-center">
                                    <tr>
                                      ...
                                      <th style="padding: 0px;">เลข Order</th>
    ...
    {{-- ADDข้อมูล --}}
    <div class="modal fade" id="addweight" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
...
<script>
        ...
        var table = $('#recieveTable').DataTable({
            ...
            processing: true,
            // serverSide: true,
            ajax: '{{ url('/weighing/sku_weight_data/factory') }}',
            columns: [
                { data: 'id', name: 'id' },
