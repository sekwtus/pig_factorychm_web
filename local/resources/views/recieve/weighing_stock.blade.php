                ...
                <div class="card">
                  <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <div class="row">
                                <div class="col-lg-4"><h2 style="color:red;margin-bottom: 0px;height: 0px;">รายงานการนับ Stock
                                </h2><br><h4 style="color:red;margin-bottom: 0px;height: 0px;padding-top: 20px;">Stock
                                    <button class="btn btn-success" style="margin-left: 250px;margin-top: 25px;" data-toggle="modal" data-target="#ADDING" ><i class="mdi mdi-plus"></i></button>
                                </h4></div>
