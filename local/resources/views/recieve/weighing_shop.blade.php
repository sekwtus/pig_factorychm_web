    ...
    <div class="card-body" style="padding: 10px;">
        <div class="table-responsive">
            <div class="row" style="zoom: 0.8;">
                <div class="col-lg-3"><h3 style="color:red;margin-bottom: 0px;height: 0px;">รายงานการชั่งน้ำหนัก (ร้านค้า)
                </h3><br><h4 style="color:red;margin-bottom: 0px;height: 0px;padding-top: 20px;">ชั่งเข้า / ชั่งออก / แปรสภาพ  
                </h4>   
                </div>
...
<div class="modal fade" id="adding" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            @if (Auth::user()->id_type == 1 || Auth::user()->id_type == 5  || Auth::user()->id_type == 15 )
                ...
                <div class="forms-sample form-control" style="height: auto;padding-right: 20px;">
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-3 pr-md-0">
                            ...
                            <input class="form-control form-control-sm" placeholder="๊USER" id="user_name" type="text" value="{{Auth::user()->name}}" name="user_name" readonly required>
                        </div>
                        <div class="col-md-3 pr-md-0">
                            <label for="weighing_date">วันที่ชั่ง</label>
                            <input class="form-control form-control-sm" placeholder="วว/ดด/ปปปป" id="weighing_date" type="text" name="weighing_date" readonly required>
                        </div>
                        <div class="col-md-3 pr-md-0">
    ...
    function datatable(date_spec,scale_number,order_number,item_code){
        ...
        var table = $('#recieveTable').DataTable({
            ...
            "footerCallback": function ( row, data, start, end, display ) {
                ...
                // Update footer
                $( api.column( 8 ).footer() ).html(pageTotal1.toFixed(0) );
                $( api.column( 9 ).footer() ).html(pageTotal2.toFixed(2) );
            ...
            // serverSide: true,
            ajax: {
                url: '{{ url('/weighing/sku_weight_data') }}',
                ...
                },            
                {
                    "targets": 13,render(data,type,row){
                        ...
                        return '<button style="padding: 7px;" type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit"\
                                    ...
                                    '+sku_code+','+sign+wg_type_name+sign+','+sign+id_wg_type+sign+','+sign+weighing_place+sign+','+sign+id_wg_sku+sign+','+sign+sku_type+sign+',\
