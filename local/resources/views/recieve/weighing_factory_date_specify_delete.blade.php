        ...
        <div class="card-body" style="padding: 10px;">
            <div class="table-responsive">
                <div class="row" style="zoom: 0.8;">
                    <div class="col-lg-3"><h3 style="color:red;margin-bottom: 0px;height: 0px;">LOG การลบน้ำหนัก (โรงงาน) &nbsp;&nbsp;</h3>
                    </div>
                ...
                <div class="row" style="zoom: 0.8;padding-bottom: 5px;padding-top: 5px;">
                    <div class="col-lg-2">
                        {{-- <a class="btn btn-success" data-toggle="modal" data-target="#adding" style="margin-bottom: 10px;" >
                    ...
                    <table class="table table-striped table-bordered nowrap" width="100%" id="recieveTable">
                        ...
                        <tr>
                            ...
                            <th style="padding: 0px;">ชื่อลบ</th>
...
<script>
    ...
    function datatable(date_spec,scale_number,order_number,item_code){
        ...
        var table = $('#recieveTable').DataTable({
            ...
            // serverSide: true,
            ajax: {
                url: '{{ url('/weighing/sku_weight_data/factory/date_specify_delete') }}',
