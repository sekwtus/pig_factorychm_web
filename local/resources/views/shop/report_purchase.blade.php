              ...
              <div class="col-lg-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12"><h2 style="color:red;margin-bottom: 0px;height: 0px;">ข้อมูลการซื้อของสาขา {{ $shop }} ประจำวันที่ {{ $shop_sales_report[0]->date_source =='' ? '' : substr($shop_sales_report[0]->date_source,3,2).'/'.substr($shop_sales_report[0]->date_source,0,2).'/'.substr($shop_sales_report[0]->date_source,6,4) }} - 
                                {{ $shop_sales_report[0]->date_destination =='' ? '' : substr($shop_sales_report[0]->date_destination,3,2).'/'.substr($shop_sales_report[0]->date_destination,0,2).'/'.substr($shop_sales_report[0]->date_destination,6,4) }}</h2></div><br>
                        </div>
...
<script>
        var table = $('#report_shop').DataTable({
            ...
            buttons: [
                {
                extend: 'excel',
                messageTop: "ข้อมูลการซื้อของสาขา {{ $shop }} \
                    ประจำวันที่ {{ $shop_sales_report[0]->date_source =='' ? '' : substr($shop_sales_report[0]->date_source,3,2).'/'.substr($shop_sales_report[0]->date_source,0,2).'/'.substr($shop_sales_report[0]->date_source,6,4)  }} - {{ $shop_sales_report[0]->date_destination =='' ? '' : substr($shop_sales_report[0]->date_destination,3,2).'/'.substr($shop_sales_report[0]->date_destination,0,2).'/'.substr($shop_sales_report[0]->date_destination,6,4)  }}"
                },
            ],
            // processing: true,
            // serverSide: true,
