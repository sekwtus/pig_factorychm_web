...
<body>
                                    <p>
                                    <div class="">
                                        <div class=" text-center alert alert-fill-danger " style="margin-bottom: 10px;"><h5>ใบ Order การตัดแต่งกระดูก วันที่สั่ง : {{ $date_format }} วันที่ส่ง : {{ $number_of_pig[0]->date_transport }}</h5>
                                        </div>
