                    ...
                    <div class="card-body">
                        {{ Form::open(['method' => 'post' , 'url' => '/shop/specail_order/request']) }}
                            <div class="forms-sample form-control" style="height: auto;padding-right: 20px;">
                                ...
                                @php $shop_code_1 = $shop->shop_code; @endphp
                                    <div class="">
                                        <div class=" text-center alert alert-fill-danger " style="margin-bottom: 10px;"><h5>ใบแกะ  test</h5>
                                            <table  class="tbl " width="100%" border="1" id="report_shop">
                                                <thead class="text-center ">
                                                <tr>
                                                    <th style="padding: 0px; height:26px; background-color:#ffffc4;color:black;" colspan="2">วันที่แกะ {{ $date_format }}</th>
                                                            ...
                                                            @endphp
                                                                @if ($item_code->item_code == $item_lists1->item_code)
                                                                    <tr>
                                                                        ...
                                                                        {{-- case sp_shop_order --}}
                                                                        @php
                                                                            $arrkey = array(1011,1034,1051,1050,1100,1102,1104,1108,1109);
                                                                        @endphp
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @foreach ($sp_order1 as $order2)
                                                                            @if ($order2->shop_code == $shop->shop_code && $order2->order_special_id == $item_lists2->order_special_id)
                                                                                <td style="padding: 0px;" class="text-center">{{ number_format($order2->number_of_item,0,'.','' ) }}</td>
                                                                                <td style="padding: 0px;" class="text-center">{{ number_format(($item_lists2->number_unit == 0 ? 0 : $order2->number_of_item/$item_lists2->number_unit),1,'.','' ) }}</td>
                                                                                @php 
                                                                                    $null_check2++; 
                                                                                @endphp
                                                                            @endif
