...
<div class="container-fluid page-body-wrapper">
    <div class="main-panel container">
        <div class="col-lg-12 grid-margin">
            {{ Form::open(['method' => 'post' , 'url' => '/customer/add/save_creditor']) }}
            <div class="card">
                <div class="card-body">
                    <div class="form-sample form-control" style="height: auto;padding-right: 24px;">
                        <div class="alert alert-fill-danger text-center" role="alert"> แบบฟอร์มสมัครสมาชิก (เจ้าหนี้) </div>
                        <div class="row py-1 ">
                        ...
                        <div class="row py-1">
                            ...
                            <div class="col-md-3 pr-md-0" hidden>ประเภทลูกค้า 
                            ...
                            <div class="col-md-2 pr-md-0" hidden>กลุ่มลูกค้า
...
<hr>
                        ...
                        <div class="row py-1">
                            <div class="col-md-2 pr-md-0">FAX No.
                                <input class="form-control form-control-sm"  placeholder="FAX" name="fax" type="text" >
                            </div>
                        </div>
<hr>
                        <div class="row py-1">
                        ...
                        <div class="row py-1">
                                <div class="col-md-2 pr-md-0"> อัตรา VAT [%]
                                    <input class="form-control form-control-sm" placeholder="0.00" name="vat" type="number" step="0.01">
                                </div>
                        </div>
                        ...
                        <div class="row py-1">
                            <div class="col-md-4 pr-md-0">บ้านเลขที่
                                <input class="form-control form-control-sm" placeholder="บ้านเลขที่" name="address_send" type="text" >
                            </div>
                            <div class="col-md-2 pr-md-0">หมู่บ้าน
                                <input class="form-control form-control-sm" placeholder="หมู่บ้าน" name="address_M_send" type="text" >
                            </div>
                            <div class="col-md-2 pr-md-0">หมู่ที่
                                <input class="form-control form-control-sm" placeholder="หมู่ที่" name="address_Mnumber_send" type="text" >
                            </div>
                            <div class="col-md-4 pr-md-0">ซอย
                                <input class="form-control form-control-sm" placeholder="ซอย" name="address_lane_send" type="text" >
                            </div>
                        </div>

                        <div class="row py-1">
                            <div class="col-md-4 pr-md-0">ถนน
                                <input class="form-control form-control-sm" placeholder="ถนน" name="address_road_send" type="text" >
                            </div>
                            <div class="col-md-2 pr-md-0">แขวง/ตำบล
                                <input class="form-control form-control-sm" placeholder="แขวง/ตำบล" name="address_district_send" type="text" >
                            </div>
                            <div class="col-md-2 pr-md-0">เขต/อำเภอ
                                <input class="form-control form-control-sm" placeholder="เขต/อำเภอ" name="address_city_send" type="text" >
                            </div>
                            <div class="col-md-4 pr-md-0">จังหวัด
                                <input class="form-control form-control-sm" placeholder="จังหวัด" name="province_send" type="text" >
                            </div>
                        </div>

                        <div class="row py-1">
                            <div class="col-md-2 pr-md-0">รหัสไปรษณีย์
                                <input class="form-control form-control-sm" maxlength="5" placeholder="รหัสไปรษณีย์" name="postcode_send" type="text" >
                            </div>
                            <div class="col-md-2 pr-md-0">เบอร์โทร
                                <input class="form-control form-control-sm" maxlength="10" placeholder="เบอร์โทร" name="phone_number_send" type="text" >
                            </div>
                            <div class="col-md-3 pr-md-0">Email
                                <input class="form-control form-control-sm" placeholder="Email" name="email_send" type="text" >
                            </div>
                            <div class="col-md-3 pr-md-0">Facebook
                                <input class="form-control form-control-sm" placeholder="Facebook" name="facebook_send" type="text" >
                            </div>
                            <div class="col-md-2 pr-md-0">Line
                                    <input class="form-control form-control-sm" placeholder="Line" name="line_send" type="text" >
                            </div>
                        </div>
                        <div class="row py-1">
                            <div class="col-md-2 pr-md-0">FAX No.
                                <input class="form-control form-control-sm"  placeholder="FAX" name="fax_send" type="text" >
                            </div>
                        </div>
