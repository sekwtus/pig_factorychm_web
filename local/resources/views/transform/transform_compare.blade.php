    ...
    <div class="row">
        <div class="col-12 px-0">
            <table id="tbl-3" class="tbl " width="100%" border="1">
                <thead>
                    <tr class="bg-secondary text-center" ><th colspan="11" style=" padding: 0px;"><h3> รายงานการแปรสภาพ ร้าน
                        <span style="color:red;">{{ $shop_name2 }} {{ $shop_name =='' ? '' : '('.$shop_name.')' }}
                ...
                <tbody>
                    @php
                        ...
                        $sum_all_unit_dift = 0;
                    @endphp
                    @foreach ($order_number as $order_)
                        @php
                            $row_num = 0;
                        @endphp
