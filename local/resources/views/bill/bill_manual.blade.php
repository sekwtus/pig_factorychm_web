                    ...
                    <table class="" width="100%" id="orderTable">
                        ...
                        <tbody>
                            @php
                                ...
                                $total = 0;
                            @endphp
                            @foreach ($detail as $detail_out)
                                @if ($bill[0]->pig_life == 1)
                                    <tr>
                                        <td class="text-center">{{$i++}}</td>
                                        <td class="text-center">{{$detail_out->lot_number}}</td>
                                        <td>ค่า{{$detail_out->price_list}}</td>
                                        <td class="text-right">{{$detail_out->sku_weight}}  Kg.</td>
                                        <td class="text-right">{{$detail_out->sku_amount}}  ตัว</td>
                                        <td class="text-right">{{ number_format($iv_list[0]->price_kg,2)}}</td>
                                        <td class="text-right">{{number_format($detail_out->sku_weight*$iv_list[0]->price_kg,2)}}</td>
                                    </tr>
                                    @php
                                        $j++;
                                        $total = $total + $detail_out->sku_weight*$iv_list[0]->price_kg;
                                    @endphp
                                @endif
                                @if ($bill[0]->pig_slice == 1)
                                    <tr>
                                        <td class="text-center">{{$i++}}</td>
                                        <td class="text-center">{{$detail_out->lot_number}}</td>
                                        <td>ค่าบริการเชือด {{$detail_out->price_list}}</td>
                                        <td class="text-right">{{$detail_out->sku_weight}}  Kg.</td>
                                        <td class="text-right">{{$detail_out->sku_amount}}  ตัว</td>
                                        <td class="text-right">{{ number_format($iv_list[0]->price_slice,2)}}</td>
                                        <td class="text-right">{{number_format($detail_out->sku_amount*$iv_list[0]->price_slice,2)}}</td>
                                    </tr>
                                    @php
                                        $j++;
                                        $total = $total + $detail_out->sku_amount*$iv_list[0]->price_slice;
                                    @endphp
                                @endif
                                @if ($bill[0]->pig_carcass == 1)
                                    <tr>
                                        <td class="text-center">{{$i++}}</td>
                                        <td class="text-center">{{$detail_out->lot_number}}</td>
                                        <td>ค่าหมูซาก {{$detail_out->price_list}}</td>
                                        <td class="text-right">{{$detail_out->sku_weight}}  Kg.</td>
                                        <td class="text-right">{{$detail_out->sku_amount}}  ตัว</td>
                                        <td class="text-right">{{ number_format($iv_list[0]->price_carcass,2)}}</td>
                                        <td class="text-right">{{number_format($detail_out->sku_weight*$iv_list[0]->price_carcass,2)}}</td>
                                    </tr>
                                    @php
                                        $j++;
                                        $total = $total + $detail_out->sku_weight*$iv_list[0]->price_carcass;
                                    @endphp
                                @endif
                                @if ($bill[0]->pig_trim == 1)
                                    <tr>
                                        <td class="text-center">{{$i++}}</td>
                                        <td class="text-center">{{$detail_out->lot_number}}</td>
                                        <td>ค่าบริการตัดแต่ง {{$detail_out->price_list}}</td>
                                        <td class="text-right">{{$detail_out->sku_weight}}  Kg.</td>
                                        <td class="text-right">{{$detail_out->sku_amount}}  ตัว</td>
                                        <td class="text-right">{{ number_format($iv_list[0]->price_trim,2)}}</td>
                                        <td class="text-right">{{number_format($detail_out->sku_amount*$iv_list[0]->price_trim,2)}}</td>
                                    </tr>
                                    @php
                                        $j++;
                                        $total = $total + $detail_out->sku_amount*$iv_list[0]->price_trim;
                                    @endphp
                                @endif
