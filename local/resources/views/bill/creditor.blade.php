        ...
        <div class="card">
            <div class="card-body">
                {{ Form::open(['method' => 'post' , 'url' => '/create_bill']) }}
                    ...
                    <div class=" text-center alert alert-fill-danger " style="margin-bottom: 10px;">สร้างบิล</div>
                    ...
                    <table class="table table-striped table-bordered nowrap table-hover table-responsive" width="100%" id="orderTable">
                        <thead class="text-center">
                            <tr>
                                ...
                                <th style="padding: 0px; font-size: 0.7rem;">ชำระบางส่วน</th>
...
<script>
        var table = $('#orderTable').DataTable({
            ...
            columns: [
                ...
                { data: 'partial_payment', name: 'partial_payment' },
                { data: 'return_product', name: 'return_product' },
...
<script language="javascript" type="text/javascript">
    ...
    function goto_print(id){
        ...
        if(r == true){
            window.open("{{ url('bill_detail_p') }}/"+id, '_blank');
            // alert(id);
        }
    }
