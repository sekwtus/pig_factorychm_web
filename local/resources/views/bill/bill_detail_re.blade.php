                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row" >
                                    ...
                                    <div class="col-md-4 pr-md-0">
                                        <div class="row">
                                            <div class="col-md-6 pr-md-0"></div><div class="col-md-6 pr-md-0"><h4>ใบเสร็จรับเงิน</h4></div>
                                        </div>
                                        {{-- <div class="row">
                                    ...
                                    <table class="" width="100%" id="orderTable">
                                        ...
                                        <tbody>
                                           ...
                                           <tr class="text-center">
                                                ...
                                                <td style="padding: 0px;">{{$item->sml_id}}</td>
                                                <td style="padding: 0px;">{{$item->date}}</td>
                                                <td style="padding: 0px;">{{$item->detail}}</td>
                                                {{-- <td style="padding: 0px;">{{$item->date_pay}}</td>
                                                <td style="padding: 0px;">{{$item->price}}</td> --}}
                                                <td style="padding: 0px;">{{number_format($item->price, 2)}}</td>
                                            </tr>
                                           @endforeach
                                           @for ($i = 0; $i <10-$l; $i++)
                                            <tr>
                                ...
                                <div class="row">
                                    <div class="col-md-8" style="border-style: solid; border-width: 1px">
                                        <div class="row text-center">
                                            ...
                                            <div class="col-md-11 text-left" style="font-size: 10pt;">เงินสด</div>
                                        </div>
                                        <div class="row text-center">
                                            <div class="col-md-1"><input type="checkbox" name="" id=""></div>
                                            <div class="col-md-11 text-left" style="font-size: 10pt;">เช็คธนาคาร............................................</div>
                                        </div>
                                        <div class="row text-center">
                                            <div class="col-md-1"> </div>
                                            <div class="col-md-11 text-left" style="font-size: 10pt;">สาขา............................................</div>
                                        </div><br>
                                        <div class="row text-center">
                                            <div class="col-md-1"></div>
                                            <div class="col-md-11 " style="font-size: 10pt;">ผู้รับเงิน............................................วันที่............................................</div>
                                        </div>
                                    </div>
                                    <div class="col-md-4" style="border-style: solid; border-width: 1px">
                                        <div class="row">
                                            <div class="col-md-12" style="font-size: 8pt;">ในนาม บจก.มงคลแอนด์ซันฟาร์ม</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12"> &nbsp;</div>
                                        </div>
