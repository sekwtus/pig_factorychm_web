            ...
            <div class="card-body">
                <div class="row" >
                    <div class="col-md-4 pr-md-0">
                        <div class="row">
                            <h3><b>บริษัท เชียงใหม่กิจมงคล จำกัด</b></h3>
                        </div>
                        <div class="row">
...
{{ Form::open(['method' => 'post' , 'url' => '/bill_add_item/t']) }}
            ...
            <div class="forms-sample form-control" style="height: auto;padding-right: 20px;">
                ...
                <div class="row" style="margin-bottom: 10px;">
                    ...
                    <div class="col-md-3 pr-md-0">
                        ...
                        <input type="number" class="form-control form-control-sm" name="bill"  value="2" hidden> 
                    </div>
                </div>
