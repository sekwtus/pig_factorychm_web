                    ...
                    {{-- <h2 class="text-center" style="margin-bottom: 0px;height: 0px;">รายงานตรวจสอบน้ำหนักชิ้นส่วนสุกรในกระบวนการผลิต <span style="color:red;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-right">
                                <a class="btn btn-warning" target="_blank" href="../report_transport_pdf/pdf_load/{{ $select_cutting_number[0]->order_number }}"  style="margin-bottom: 10px;">
                                    <i class="fa fa-print">พิมพ์(ไม่มีน้ำหนัก)</i>
                                </a>
