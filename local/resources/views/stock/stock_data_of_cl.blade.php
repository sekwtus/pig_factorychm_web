                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="float-right">
                                        <p class="mb-0 text-right">คงเหลือ (ซีก)</p>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="float-right">
                                        <p class="mb-0 text-right">ยอดรับเข้าวันนี้ (ซีก)</p>
                                        <div class="fluid-container">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="float-right">
                                        <p class="mb-0 text-right">ยอดที่ Order วันนี้ (ซีก)</p>
                                        <div class="fluid-container">
                                        <h3 class="font-weight-medium text-right mb-0"></h3>
                                        <h3 class="font-weight-medium text-right mb-0">{{ ( empty($unit_release[0]->total_pig) ? 0 : $unit_release[0]->total_pig * 2) }}</h3>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="float-right">
                                        <p class="mb-0 text-right">ยอดจ่ายออกวันนี้ (ซีก)</p>
                                        <div class="fluid-container">
                                        <h3 class="font-weight-medium text-right mb-0">{{ ( empty($unit_release[0]->count_amount) ? 0 : $unit_release[0]->count_amount) }}</h3>
                                        </div>
                                    </div>
                                    </div>
                                </div>
...
<script>
    function dataStockOrder(daterangeFilter){
        // stock_of_red_receive
        $.ajax({
            type: 'GET',
            dataType: 'JSON',
            url: '{{ url('stock_cl_receive') }}',
            ...
            success: function (data) {
               console.log(data); 
                    var row = '';
                    var count_row = 1;
                    var balance = (data[0].length == 0 ? 0 : data[0][0].balance);
                    var balance_weight = (data[0].length == 0 ? 0 : data[0][0].weight_summary);
                ...
                data[1].forEach(element => { 
                        ...
                        count_row++;
                        sum_total_pig_int = sum_total_pig_int+element.count_amount;
                        sum_weight_int = sum_weight_int+element.sum_weight;
                    });
                ...
                data[2].forEach(element => {
                        ...
                        count_row++;
                        sum_total_pig_out = sum_total_pig_out+element.count_amount;
                        sum_weight_out = sum_weight_out+element.sum_weight;
                        date_ = element.date;
                    });
                ...
                stockOrder();
                $('#count_pig_summary').val( ((parseFloat(balance)+sum_total_pig_int) - sum_total_pig_out) );
