    ...
    <div class="row">
        <div class="col-12 px-0">
            <table id="tbl-3" class="tbl " width="100%" border="1">
                <thead>
                    <tr class="bg-secondary text-center" ><th colspan="11" style=" padding: 0px;"><h3> รายงานการโอน
                    ...
                    <tr class="bg-secondary text-center">
                        <th width="50%" style=" padding: 0px;" colspan="5">ก่อนโอน</th>
                        <th width="40%" style=" padding: 0px;" colspan="4">หลังโอน</th>
