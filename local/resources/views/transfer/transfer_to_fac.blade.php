...
<div class="row ">
    <div class="col-lg-5 grid-margin">
        <div class="card">
            <div class="card-body">
                {{ Form::open(['method' => 'post' , 'url' => '/create_order_transfer_to_fac/create_order']) }}
                <div class="forms-sample form-control" style="height: auto;padding-right: 20px;">
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-md-5 pr-md-0">
                            <label for="customer">สาขา ร้านค้า</label>
                    ...
                    <div class="row">
                        <div class="col-md-5 pr-md-0">
                            <label for="markerB">ทะเบียนรถที่จัดส่ง</label>
                            <input type="text" class="form-control form-control-sm" id="vehicle" name="vehicle"  placeholder="ทะเบียนรถ" >
                        </div>
                    </div>
...
<div class="col-lg-7 grid-margin">
    <div class="card">
        <div class="card-body ">
            <div class="row">
                <div class="col-5">
                    <h4>รายการ ใบโอนสินค้าคืนโรงงาน</h4>
                </div>
