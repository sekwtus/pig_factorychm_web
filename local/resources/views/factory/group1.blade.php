{{-- group1 --}}
    ...
    <tr>
        ...
        <td style="padding: 0px; height: 20px;" class="text-center" rowspan="{{ $span+($group_row_span[$key]->count_row *2) }}">{{ $item_mian->yield_main }}</td>
        ...
        @else
            <td style="padding: 0px; height: 20px;" class="text-center" rowspan="{{ $span+($group_row_span[$key]->count_row *2) }}">{{ $sum_number_of_pig }} </td>
    
        @endif

        {{-- <td style="padding: 0px; height: 20px;" class="text-center" rowspan="{{ $span+($group_row_span[$key]->count_row *2) }}">{{ $item_mian->yield_main*$sum_number_of_pig }} </td> --}}
        <td style="padding: 0px; height: 20px;" class="text-center" rowspan="{{ $span+($group_row_span[$key]->count_row *2) }}">{{ ($item_mian->yield_per_one == null ? '' : number_format( $item_mian->yield_main/$item_mian->yield_per_one , 2, '.', '') ) }}</td>

        @foreach ($sp_summary_weight as $summary_weight)
            @if ($item_mian->item_code2 == $summary_weight->item_code2)
            <td style="padding: 0px; height: 20px; background-color:#80ff80;" class="text-center" rowspan="{{ $span+($group_row_span[$key]->count_row *2) }}" >
        ...
        @if ($check_weight == 0)
                ...
                <td style="padding: 0px; height: 20px; background-color:#ff8080;" class="text-center" rowspan="{{ $span+($group_row_span[$key]->count_row *2) }}" >{{ $request_fill->weight*$sum_number_of_pig }}</td>
                    @php
                        $check_fill_exist2++;
                ...
                <td style="padding: 0px; height: 20px; background-color:#9fff9f;" class="text-center" rowspan="{{ $span+($group_row_span[$key]->count_row *2) }}" >{{ $item_mian->yield_main == null ? $sum_number_of_pig : $item_mian->yield_main*$sum_number_of_pig }}</td>
                @php
