 ...
 <tr>
     ...
     @if ($check_weight == 0)
        ...
        <td hidden  style="padding: 0px; height: 20px; background-color:#9fff9f;" class="text-center" rowspan="3" > {{ $item_mian->yield_main == null ? $sum_number_of_pig : $item_mian->yield_main*$sum_number_of_pig }}</td>
             @php
                 $weight_balance = ( $item_mian->yield_main == null ? $sum_number_of_pig : $item_mian->yield_main*$sum_number_of_pig );
             @endphp
             @endif
         <td  hidden style="padding: 0px; height: 20px;" class="text-center" rowspan="3">{{ ($item_mian->yield_per_one == null ? '' : $item_mian->yield_main*$sum_number_of_pig / number_format( $item_mian->yield_main/$item_mian->yield_per_one , 2, '.', '') ) }}</td>
     @endif
