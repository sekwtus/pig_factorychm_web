...
<a href="{{url('/index_other')}}" class="btn btn-warning">
  <i class="link-icon mdi mdi-exclamation"></i>
    <span class="menu-title">ยังไม่แยกหมวด</span>
</a>
            <div class="col-12 grid-margin d-none d-lg-block border background-col ">
              <div class="intro-banner">
                ...
                <div class="content-area align-items-center">
                  <h2 class="mb-0">เปิดเเล้ว!! ตลาดหมู เอ็ม เค</h2>
                  <h5 class="mb-0">เนื้อหมูสด สะอาด ปลอดภัย คุณภาพเหนือมาตรฐาน ส่งตรงจากฟาร์มทุกวัน</h4>
                </div>
