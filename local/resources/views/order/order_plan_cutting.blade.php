        ...
        <div class="card">
            <div class="card-body " style=" padding-bottom: 0px; padding-top: 10px;">
                ...
                <div class="col-2 text-center">
                    ...
                    {{-- <input type="button" onclick="create_cutting_order()" class="btn btn-info " id="btnCreate_cutOrder"  value="แผนการตัดแต่ง +" style="margin-bottom: 10px;padding:10px;font-size:25px;" data-toggle="modal" data-target="#cutOrder"/> --}}
                </div>
                <div class="col-10">
            ...
            <div class="card-body " style="padding: 10px;">
                <div class=" text-center alert alert-fill-danger " style="margin-bottom: 10px;padding-bottom: 0px;padding-top: 5px;">
                    <div class="row">
                        ...
                        <h3 class="col-6" style="height: 25px;margin-bottom: 0px;padding-bottom: 35px; color:black;" id="switch_button" ><b>OVER NIGHT STOCK</b></h3>
                    </div>
                </div>
                <table class="table table-striped table-bordered nowrap table-hover table-responsive"  width="100%" id="orderTable">
                    <thead class="text-center">
                        <tr>
                            <th style="padding: 0px; padding-left: 5px;padding-right: 5px;  font-size: 0.7rem; font-size: 0.7rem;">เลขที่ Order</th>
                            <th style="padding: 0px; font-size: 0.7rem;">สาขา</th>
                            <th style="padding: 0px; padding-left: 5px;padding-right: 5px;  font-size: 0.7rem;">รอบที่</th>
                            <th style="padding: 0px; padding-left: 5px;padding-right: 5px; font-size: 0.7rem;">ตัวย่อ</th>
                            <th style="padding: 0px; font-size: 0.7rem;">จำนวน(ตัว)</th>
                            <th style="padding: 0px; font-size: 0.7rem;">ประเภท</th>
                            <th style="padding: 0px; padding-left: 10px;padding-right: 10px;font-size: 0.7rem;">วันที่ตัดแต่ง</th>
                            <th style="padding: 0px; padding-left: 10px;padding-right: 10px;font-size: 0.7rem;">วันที่จัดส่ง</th>
                            <th style="padding: 0px; padding-left: 5px;padding-right: 5px;font-size: 0.7rem;">หมายเหตุ</th>
    ...
    <div class="col-lg-6 grid-margin">
        <div class="card">
            <div class="card-body "  style="padding: 10px;">
                ...
                <table class="table table-striped table-bordered table-hover" width="100%" id="orderTableLot">
                    <thead class="text-center">
                        <tr>
                        <th style="padding: 0px; font-size: 0.7rem;">Order</th>
                        <th style="padding: 0px; font-size: 0.7rem;">process No.</th>
                        <th style="padding: 0px; font-size: 0.7rem;">ลูกค้า</th>
                        <th style="padding: 0px; font-size: 0.7rem;">รอบที่</th>
                        <th style="padding: 0px; font-size: 0.7rem;">รหัสย่อ</th>
                        <th style="padding: 0px; font-size: 0.7rem;">แผนผลิต</th>
                        <th style="padding: 0px; font-size: 0.7rem;">จำนวน</th>
                        <th style="padding: 0px; font-size: 0.7rem;">ช่วง นน.</th>
...
<script>
        ...
        var table = $('#orderTable').DataTable({
            ...
            // serverSide: true,
            ajax: {
                    url: '{{ url('order_cutting/get_ajax/today') }}',
...
<script>
    function tableOrderLot(lot){
        ...
        var table2 = $('#orderTableLot').DataTable({
            ...
            // serverSide: true,
            ajax: {
                    url: '{{ url('order_cutting/get_ajax_inLot') }}',
    ...
    function setOrder(order_number,total_pig){
        ...
        if (lot == 'กรุณาสร้าง LOT') {
            ...
            $.ajax({
                ...
                url: '{{ url('addOrderCutting_to_lot') }}',
