                ...
                {{ Form::open(['method' => 'post' , 'url' => '/create_order_ov/create_order']) }}
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-md-6 pr-md-0">
                            ...
                            <select class="form-control form-control-sm" id="order_ref" name="order_ref" style=" height: 30px; " onchange="check_stock(this)">
                                <option></option>
                            ...
                            <div class="row" style="margin-bottom: 10px;">\
                                <div class="col-md-5 pr-md-0">\
                                    ...
                                    <select class="form-control form-control-sm" id="order_ref" name="order_ref" style=" height: 30px; " >\
                                        <option value="'+order_ref+'">'+order_ref+'</option>\
                                        @foreach ($order_ref as $order_)\
                                            <option value="{{ $order_->order_number }}">{{ $order_->order_number }} | เหลือ {{ $order_->side_of_pig }} ตัว</option> \
                                        @endforeach\
                                    </select>\
