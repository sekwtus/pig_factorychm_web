...
<div class="row ">
    <div class="col-lg-12 grid-margin">
        <div class="card">
            <div class="card-body">
                {{ Form::open(['method' => 'put' , 'url' => 'create_order_transfer/update']) }}
                ...
                <div class="forms-sample form-control" style="height: auto;padding-right: 20px;">
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-md-6 pr-md-0">
                            ...
                            <select class="form-control form-control-sm" id="type_req" name="type_request"
                        ...
                        <div class="col-md-6 pr-md-0">
                            ...
                            <input class="form-control form-control-sm" placeholder="วว/ดด/ปปปป" id="dateOffal"
                                type="text" name="dateOffal" value="{{$data_out->date}}" required>
                        </div>
                        {{--
                ...
                <div class="row" style="margin-bottom: 10px;">
                    <div class="col-md-4 pr-md-0">
                        ...
                        <select class="form-control form-control-sm" onchange="setMarkerA(this)" id="customer_from"
                            name="customer_from" style=" height: 30px; " readonly required >
                            <option value="{{ $data_out->id_user_customer_from }}" selected>{{ $data_out->id_user_customer_from }}</option> 
                        </select>
                    ...
                    <div class="col-md-4 pr-md-0">
                        ...
                        <select class="form-control form-control-sm" onchange="setMarkerB(this)" id="customer_to"
                            ...
                            <option value="{{ $data_out->id_user_customer_to }}" selected readonly>{{ $data_out->id_user_customer_to }}</option>
                            <option disabled></option>
                ...
                <div class="row" style="margin-bottom: 10px;">
                    ...
                    <div class="col-md-6 pr-md-0">
                        ...
                        <select class="form-control form-control-sm" id="order_ref" name="order_ref"
                            ...
                            <option value="{{ $data_out->order_ref}}" selected readonly>{{ $order_->order_number }} | เหลือ
                    ...
                    <div class="col-md-6 pr-md-0">
                        ...
                        <input type="text" class="form-control form-control-sm" id="provider" name="id_user_provider"
                            placeholder="ผู้จัดทำ" value="{{ $data_out->id_user_provider }}">
                    </div>
                </div>
                ...
                <div class="row" style="margin-bottom: 10px;">
                    <div class="col-md-12 pr-md-0">
                        ...
                        <textarea class="form-control form-control-sm" id="note" name="note" rows="3"
                            placeholder="หมายเหตุ">{{ $data_out->note}}</textarea>
                    </div>
                </div>
                ...
                <div class="text-center" style="padding-top: 10px;">
                    <button type="submit" class="btn btn-success mr-2">ยืนยัน</button>&emsp;
