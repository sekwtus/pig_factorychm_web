...
<div class="row ">
    <div class="col-lg-5 grid-margin">
        <div class="card">
            <div class="card-body">
                {{ Form::open(['method' => 'post' , 'url' => '/create_order_marinade/create_order']) }}
                    <div class="forms-sample form-control" style="height: auto;padding-right: 20px;">
                    <div class=" text-center alert alert-fill-danger " style="margin-bottom: 10px;">ใบสั่ง Marinade</div>
                    <div class="row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-4 pr-md-0">
                            <label for="orderDate">วันที่ตัดแต่ง</label>
                            <input class="form-control form-control-sm" placeholder="วว/ดด/ปปปป" id="dateCutting" type="text" name="dateCutting" value="" required>
                        </div>
                        ...
                        <div class="col-md-6 pr-md-0">
                            ...
                            <select class="form-control form-control-sm" id="order_ref" name="order_ref" style=" height: 30px; " >
                                ...
                                @foreach ($order_ref as $order_)
                                    <option value="{{ $order_->order_number }}">{{ $order_->order_number }} </option> 
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6 pr-md-0">
    ...
    <div class="col-lg-7 grid-margin">
        <div class="card">
            <div class="card-body ">
                <div class="row">
                    <div class="col-4"><h4>รายการ Marinade</h4></div>
                    ...
                    <table class="table table-striped table-bordered nowrap table-hover table-responsive" width="100%" id="orderTable">
                        <thead class="text-center">
                            ...
                            <th style="padding: 0px; font-size: 0.7rem;">วันที่ตัดแต่ง</th>
...
{{-- edit order --}}
{{ Form::open(['method' => 'post' , 'url' => 'order_marinade/edit']) }}
...
<script>
        var table = $('#orderTable').DataTable({
            ...
            // processing: true,
            // serverSide: true,
            ajax: '{{ url('create_order_marinade/get_ajax') }}',
            columns: [
            ...
            columnDefs: [
            {
                ...
                "className": "text-center",render(data,type,row){
                    return '<a target="blank_" href="summary_weighing_cutting/'+data+'">'+data+'</a>';
                }
            },
            {
                "targets": 1,
...
<script>
    function editModal(order_number,id_user_customer,marker,total_pig,weight_range,date,note,type_request,order_type,round,order_ref){
        $("#EDIT").modal();
        var get_type_order = '';
        var get_status = '';
            $.ajax({
                    ...
                    var str = '<div class="forms-sample form-control" style="height: 400px;padding-right: 20px;">\
                            ...
                            <div class="row" style="margin-bottom: 10px;">\
                                ...
                                <div class="col-md-4 pr-md-0">\
                                    ...
                                    <input class="form-control form-control-sm" placeholder="วว/ดด/ปปปป" type="text" id="datepicker2" name="dateCutting" value="'+date+'" required></div>\
                                <div class="col-md-4 pr-md-0">\
