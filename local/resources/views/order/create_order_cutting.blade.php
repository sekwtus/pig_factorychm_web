...
<div class="row ">
    <div class="col-lg-5 grid-margin">
        <div class="card">
            <div class="card-body">
                {{ Form::open(['method' => 'post' , 'url' => '/create_order_cutting/create_order']) }}
                    <div class="forms-sample form-control" style="height: auto;padding-right: 20px;">
                    <div class=" text-center alert alert-fill-danger " style="margin-bottom: 10px;">ใบสั่งแผนตัดแต่ง</div>
                        ...
                        <div class="col-md-6 pr-md-0">
                            ...
                            <select class="form-control form-control-sm" id="order_ref" name="order_ref" style=" height: 30px; " >
                                ...
                                @foreach ($order_ref as $order_)
                                    <option value="{{ $order_->order_number }}">{{ $order_->order_number }} | เหลือ {{ $order_->current_pig }} ตัว</option> 
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6 pr-md-0">
...
<script>
        var table = $('#orderTable').DataTable({
            ...
            // processing: true,
            // serverSide: true,
            ajax: '{{ url('create_order_cutting/get_ajax') }}',
            columns: [
